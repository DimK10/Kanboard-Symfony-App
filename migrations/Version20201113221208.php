 ...
 */
final class Version20201113221208 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE progress (id INT AUTO_INCREMENT NOT NULL, workspace_id_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_2201F246A6ADFB8 (workspace_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, progress_id_id INT DEFAULT NULL, workspace_id_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, color VARCHAR(7) NOT NULL, INDEX IDX_527EDB259DFC6D6C (progress_id_id), INDEX IDX_527EDB25A6ADFB8 (workspace_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
